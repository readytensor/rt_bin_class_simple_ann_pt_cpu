# Artificial Neural Network Classifier in Pytorch (CPU) with Shapley Explanations
## Project Description
...
- A **Artificial Neural Network (ANN)** classifier built using **PyTorch**. The model runs on CPU.
